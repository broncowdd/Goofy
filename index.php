...
$bookmarklet='<a class="btn" href="javascript:javascript:(function(){var content = document.querySelector(\'.code\').value;var reg=new RegExp(\'(http://[^\\\']+)\',\'gi\');url=reg.exec(content.value);window.open(\''.$me.'?q=\'+ encodeURIComponent(url),\'_blank\',\'menubar=yes,height=600,width=1000,toolbar=yes,scrollbars=yes,status=yes\');})();" >Goofy</a>';
